      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={deliver}
              className="text-slate-500 py-2 px-4 rounded-lg bg-white active:bg-slate-100 hover:bg-slate-200 text-sm"
            >
              Kirim
            </button>
          </div>
          ...
          {deliverOrder?.map((item, index) => (
            <tbody key={index} className="text-[10px]">
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">{formatPrice(item.totalPrice)}</td>
                <td className="px-6 py-4">{item.customer.address}</td>
